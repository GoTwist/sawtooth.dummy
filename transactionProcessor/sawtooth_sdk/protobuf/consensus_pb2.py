...
_CONSENSUSPEERMESSAGEHEADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='signer_public_key', full_name='ConsensusPeerMessageHeader.signer_public_key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message_sha512', full_name='ConsensusPeerMessageHeader.message_sha512', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='ConsensusPeerMessageHeader.name', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='ConsensusPeerMessageHeader.version', index=3,
...
_CONSENSUSPEERMESSAGEENVELOPE = _descriptor.Descriptor(
  name='ConsensusPeerMessageEnvelope',
  full_name='ConsensusPeerMessageEnvelope',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='ConsensusPeerMessageEnvelope.header', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='header_signature', full_name='ConsensusPeerMessageEnvelope.header_signature', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='ConsensusPeerMessageEnvelope.message', index=2,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ConsensusPeerMessageEnvelope'] = _CONSENSUSPEERMESSAGEENVELOPE
...
ConsensusPeerMessageEnvelope = _reflection.GeneratedProtocolMessageType('ConsensusPeerMessageEnvelope', (_message.Message,), dict(
  DESCRIPTOR = _CONSENSUSPEERMESSAGEENVELOPE,
  __module__ = 'sawtooth_sdk.protobuf.consensus_pb2'
  # @@protoc_insertion_point(class_scope:ConsensusPeerMessageEnvelope)
  ))
_sym_db.RegisterMessage(ConsensusPeerMessageEnvelope)
